...
```javascript
import nanmskmin from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-nanmskmin@v0.1.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/stats-base-nanmskmin/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-base-nanmskmin/actions/workflows/test.yml?query=branch:v0.1.1
